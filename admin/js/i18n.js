...
const ADMIN_TRANSLATIONS = {
  en: {
    ...
    'nav.group.settings': 'Website Settings',
    ...
    'about.editor.title': 'About Page',
    'about.editor.desc': 'Manage the content displayed on the public About page.',
    'about.editor.previewPage': 'Preview Page',
    'about.editor.navHeading': 'About Page',
    'about.editor.nav.story': 'Story',
    'about.editor.nav.related': 'Other About sections',
    'about.editor.related.hero': 'Page Hero',
    'about.editor.related.images': 'Story Image',
    'about.editor.related.stats': 'Numbers & Stats',
    'about.editor.related.timeline': 'History / Timeline',
    'about.editor.related.certifications': 'Certifications',
    'about.editor.collapse': 'Collapse',
    'about.editor.expand': 'Expand',
    'about.editor.complete': 'Complete',

    'lang.readOnlyNote': 'Managed in code, not editable here.',
    'lang.missingTranslation': 'Missing translation — showing English.',
    ...
    'settings.desc': 'Company details used site-wide — contact info, facility address, and footer text.',
    'settings.section.contact': 'Contact Details',
    'settings.section.contactDesc': 'Shown in the header, footer, and contact page across the site.',
    'settings.section.address': 'Facility Address',
    'settings.section.addressDesc': 'The manufacturing facility address shown in the footer and contact page.',
    'settings.section.footer': 'Footer',
    'settings.section.footerDesc': 'The short company blurb shown in the site footer.',
    'settings.section.branding': 'Branding',
    'settings.section.brandingDesc': 'Logo and brand colors, managed on their own page.',
    'settings.branding.manageLink': 'Manage Branding & Logo',
    ...
    'content.emptyRedirect': 'Nothing here yet. About Page content lives under About Page, and footer/contact details live under Website Settings.',
  ...
  tr: {
    ...
    'nav.group.settings': 'Web Sitesi Ayarları',
    'nav.settings': 'Web Sitesi Ayarları',
    'nav.group.content': 'İçerik ve Metin',
    'nav.about': 'Hakkımızda Sayfası',
    ...
    'about.editor.title': 'Hakkımızda Sayfası',
    'about.editor.desc': 'Genel Hakkımızda sayfasında görünen içeriği yönetin.',
    'about.editor.previewPage': 'Sayfayı Önizle',
    'about.editor.navHeading': 'Hakkımızda Sayfası',
    'about.editor.nav.story': 'Hikaye',
    'about.editor.nav.related': 'Diğer Hakkımızda bölümleri',
    'about.editor.related.hero': 'Sayfa Kapak Görseli',
    'about.editor.related.images': 'Hikaye Görseli',
    'about.editor.related.stats': 'Sayılar ve İstatistikler',
    'about.editor.related.timeline': 'Tarihçe / Zaman Çizelgesi',
    'about.editor.related.certifications': 'Sertifikalar',
    'about.editor.collapse': 'Daralt',
    'about.editor.expand': 'Genişlet',
    'about.editor.complete': 'Tamamlandı',

    'lang.readOnlyNote': 'Kodda yönetiliyor, burada düzenlenemez.',
    'lang.missingTranslation': 'Çeviri eksik — İngilizce gösteriliyor.',
    'lang.name.en': 'English',
    'lang.name.ar': 'العربية',
    'lang.name.tr': 'Türkçe',
    'lang.name.ku': 'کوردی',

    'settings.title': 'Web Sitesi Ayarları',
    'settings.desc': 'Site genelinde kullanılan şirket bilgileri — iletişim bilgileri, tesis adresi ve alt bilgi metni.',
    'settings.section.contact': 'İletişim Bilgileri',
    'settings.section.contactDesc': 'Sitedeki üst bilgi, alt bilgi ve iletişim sayfasında gösterilir.',
    'settings.section.address': 'Tesis Adresi',
    'settings.section.addressDesc': 'Alt bilgide ve iletişim sayfasında gösterilen üretim tesisi adresi.',
    'settings.section.footer': 'Alt Bilgi',
    'settings.section.footerDesc': 'Site altbilgisinde gösterilen kısa şirket açıklaması.',
    'settings.section.branding': 'Marka',
    'settings.section.brandingDesc': 'Logo ve marka renkleri, kendi sayfasında yönetilir.',
    'settings.branding.manageLink': 'Marka ve Logoyu Yönet',
    ...
    'content.emptyRedirect': 'Burada henüz bir şey yok. Hakkımızda Sayfası içeriği Hakkımızda Sayfası altında, alt bilgi/iletişim bilgileri ise Web Sitesi Ayarları altındadır.',
