...
export type AdminLocale = 'en' | 'tr'

export const ADMIN_LOCALES: readonly AdminLocale[] = ['en', 'tr']
...
export const ADMIN_TRANSLATIONS: Record<AdminLocale, Record<string, string>> = {
  "en": {
    ...
    "page.theme.title": "Theme & Colours",
    "page.theme.desc": "Every background, text, button and alert colour on the public site — edit, save, and it goes live immediately.",
    ...
    "toast.themeFailedLoad": "Failed to load theme.",
    ...
    "theme.group.backgrounds": "Backgrounds",
    "theme.group.typography": "Text & Typography",
    "theme.group.buttons": "Buttons & Interactive Elements",
    "theme.group.state": "State & Accent Colours",
    ...
    "theme.token.header_bg": "Header background",
    "theme.token.footer_bg": "Footer background",
    "theme.token.heading_color": "Headings",
    "theme.token.body_text_color": "Body text",
    "theme.token.secondary_text_color": "Secondary text",
    "theme.token.muted_text_color": "Muted / caption text",
    "theme.token.link_color": "Links",
    "theme.token.icon_color": "Icons",
    "theme.token.btn_fill_bg": "Filled button — background",
    "theme.token.btn_fill_bg_hover": "Filled button — hover",
    "theme.token.btn_fill_bg_active": "Filled button — active",
    "theme.token.btn_fill_text": "Filled button — text",
    "theme.token.btn_fill_border": "Filled button — border",
    "theme.token.btn_ghost_text": "Ghost button — text",
    "theme.token.btn_ghost_border": "Ghost button — border",
    "theme.token.btn_ghost_border_hover": "Ghost button — hover border",
    "theme.token.btn_disabled_bg": "Disabled button — background",
    "theme.token.btn_disabled_text": "Disabled button — text",
    "theme.token.btn_disabled_border": "Disabled button — border",
    "theme.token.state_success": "Success",
    "theme.token.state_warning": "Warning",
    "theme.token.state_danger": "Error / Danger",
    "theme.token.state_info": "Info",
    "theme.preview.heading": "Gold Pelet",
    "theme.preview.body": "Gold Pelet produces potato, corn and wheat pellet snacks.",
    "theme.preview.secondary": "Six flavours, six cuts, built for scale.",
    "theme.preview.link": "Learn more",
    "theme.preview.btnFill": "Contact sales",
    "theme.preview.btnGhost": "Download",
    "theme.preview.btnDisabled": "Unavailable",
    "theme.preview.badgeSuccess": "Success",
  ...
  "tr": {
    ...
    "page.theme.title": "Tema ve Renkler",
    "page.theme.desc": "Genel sitedeki her arka plan, metin, buton ve uyarı rengi — düzenleyin, kaydedin, anında yayına girsin.",
    ...
    "toast.themeFailedLoad": "Tema yüklenemedi.",
    "toast.themeSaved": "Tema kaydedildi.",
    "toast.themeSaveFailed": "Tema kaydedilemedi.",
    ...
    "theme.group.backgrounds": "Arka Planlar",
    "theme.group.typography": "Metin ve Tipografi",
    "theme.group.buttons": "Butonlar ve Etkileşimli Öğeler",
    "theme.group.state": "Durum ve Vurgu Renkleri",
    ...
    "theme.token.header_bg": "Üst bilgi arka planı",
    "theme.token.footer_bg": "Alt bilgi arka planı",
    "theme.token.heading_color": "Başlıklar",
    "theme.token.body_text_color": "Gövde metni",
    "theme.token.secondary_text_color": "İkincil metin",
    "theme.token.muted_text_color": "Soluk / açıklama metni",
    "theme.token.link_color": "Bağlantılar",
    "theme.token.icon_color": "Simgeler",
    "theme.token.btn_fill_bg": "Dolgulu buton — arka plan",
    "theme.token.btn_fill_bg_hover": "Dolgulu buton — üzerine gelince",
    "theme.token.btn_fill_bg_active": "Dolgulu buton — aktif",
    "theme.token.btn_fill_text": "Dolgulu buton — metin",
    "theme.token.btn_fill_border": "Dolgulu buton — kenarlık",
    "theme.token.btn_ghost_text": "Hayalet buton — metin",
    "theme.token.btn_ghost_border": "Hayalet buton — kenarlık",
    "theme.token.btn_ghost_border_hover": "Hayalet buton — üzerine gelince kenarlık",
    "theme.token.btn_disabled_bg": "Devre dışı buton — arka plan",
    "theme.token.btn_disabled_text": "Devre dışı buton — metin",
    "theme.token.btn_disabled_border": "Devre dışı buton — kenarlık",
    "theme.token.state_success": "Başarılı",
    "theme.token.state_warning": "Uyarı",
    "theme.token.state_danger": "Hata",
    "theme.token.state_info": "Bilgi",
    "theme.preview.heading": "Gold Pelet",
    "theme.preview.body": "Gold Pelet, patates, mısır ve buğday pelet atıştırmalıkları üretir.",
    "theme.preview.secondary": "Altı çeşni, altı kesim, ölçek için üretildi.",
    "theme.preview.link": "Daha fazla bilgi",
    "theme.preview.btnFill": "Satışla iletişime geçin",
    "theme.preview.btnGhost": "İndir",
    "theme.preview.btnDisabled": "Kullanılamıyor",
    "theme.preview.badgeSuccess": "Başarılı",
